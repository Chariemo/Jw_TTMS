...
public class EmployeeDAO implements IEmployee
{
    ...
    public ArrayList<Employee> findEmployeeByPage(int cPage, String emp_name)
    {
        ...
        try
        {
            ...
            while (rs.next())
            {
                ...
                employee.setEmp_image(rs.getString("emp_image"));
    ...
    public boolean insert(Employee employee)
    {
        ...
        try
        {
            String sql = "insert into employee(emp_no, emp_name, emp_tel_num, emp_addr, emp_email, emp_image) values(?,?,?,?,?,?)";
            ...
            pstmt.setString(6, employee.getEmp_image());
    ...
    public boolean update(Employee employee)
    {
        ...
        try
        {
            String sql = "update employee set emp_no=?,emp_name=?,emp_tel_num=?,emp_addr=?,emp_email=?,emp_image=? where emp_id=?";
            pstmt = con.prepareStatement(sql);
            pstmt.setString(1, employee.getEmp_no());
            pstmt.setString(2, employee.getEmp_name());
            pstmt.setString(3, employee.getEmp_tel_num());
    ...
    public ArrayList<Employee> findEmployeeAll()
    {
        ...
        try
        {
            ...
            while(rs.next())
            {
                ...
                info.setEmp_image(rs.getString("emp_image"));
                // 加入列表
                list.add(info);
            }
        }
	...
	public Employee findEmployeeByNo(String no)
    {
        ...
        {
            // 获取所有用户数据:模糊查询
            pstmt = con.prepareStatement("select * from employee where emp_no = " + no);
